...
%% put your name here, so we know who to give credit to %%
    Jaechol Lee, Wenjun Wang, and Marshall Blundell
}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\hw}{%%%%%%%%%%%%%%%%%%%%
...
First we set up and make some useful functions.
<<setUpChunk>>=
library(pacman)
...
# parameters (including variance), and e, a matrix of residuals, 
...
# 
# report.stats() takes a vector dependent variable y, a matrix
# of regressors X, # and fitted values beta and compiles summary
# stats in a list
#
...
There are some outliers which\dots
...
Fit is improved\dots Including the square term does not violate any of our assumptions, in
particular it does not violate the full rank condition because it is 
not a linear function of \textbf{GDPpc}.
